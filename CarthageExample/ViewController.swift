...
class ViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBAction func send2server(_ sender: Any) {
        ...
        let parameters = ["user":"John", "password":"Papajani"]
        
        // Image to upload:
        let imageToUploadURL = Bundle.main.url(forResource: "image", withExtension: "jpg")
        
        // Server address (replace this with the address of your own server):
        let url = "https://2eec40d5.ngrok.io/getimage.php"
    ...
    @IBAction func sendPic(_ sender: Any) {             //  SEND  IMAGE TO WATSON FUNCTION
